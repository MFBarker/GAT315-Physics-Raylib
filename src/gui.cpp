...
void GUI::Draw()
{
	...
	/*
            GuiSliderBar((Rectangle){  }, "Damping", NULL, &dampingValue, 0, 100);
            GuiSliderBar((Rectangle){  }, "Restitution", NULL, &restitutionValue, 0, 100);
            GuiLabel((Rectangle){  }, "Body Type");
            GuiGroupBox((Rectangle){  }, "Spring");
            GuiSliderBar((Rectangle){  }, "Damping", NULL, &springDampingValue, 0, 100);
            GuiSliderBar((Rectangle){  }, "Stiffness", NULL, &stiffnessValue, 0, 100);
            GuiGroupBox((Rectangle){  }, "World");
            GuiSliderBar((Rectangle){  }, "Gravitation", NULL, &gravitationValue, 0, 100);
            GuiSlider((Rectangle){  }, "Gravity", NULL, &gravityValue, 0, 100);
            GuiSliderBar((Rectangle){  }, "Spring Multiplier", NULL, &springSiffnessMultiplierValue, 0, 100);
            if (GuiDropdownBox((Rectangle){  }, "Dynamic;Kinematic;Static", &bodyTypeActive, bodyTypeEditMode)) bodyTypeEditMode = !bodyTypeEditMode;
	*/
